...
@section('content')
    ...
    <section>
        ...
        <div class="container row mx-auto py-3">
            ...
            <img id="aboutMe1" class="img-fluid col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 my-3" src="../img/professional/francielly-rodrigues-11.jpg" alt="Francielly no evento Sumirê Fashion Show.">
        </div>
    </section>
    <section>
        <div id="aboutImgPage3" class="parallax"></div>
        <div class="container row mx-auto py-3">
            <img id="aboutMe2" class="img-fluid col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 my-3 mx-auto" src="../img/professional/francielly-rodrigues-12.jpg" alt="Francielly no evento Beauty Fair.">
