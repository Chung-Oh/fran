...
<main>
    <section id="home" class="parallax"> <!-- Jumbotron -->
        <h1 class="title-jumbo">Francielly Rodrigues</h1>
        <h5 class="subtitle-jumbo">Maquiadora Profissional</h5>
    </section>

    <section> <!-- Service -->
        <div id="service" class="parallax"></div>
        <h2 class="name-section text-center py-3">Serviços <span class="dot">.</span></h2>
    ...
    <section> <!-- About -->
        <div id="about" class="parallax"></div>
        <h2 class="name-section text-center py-3">Quem sou <span class="dot">.</span></h2>
    ...
    <section id="jobs"> <!-- Jobs -->
        <div>
            <h2 class="name-section text-center py-3">Portfólio <span class="dot">.</span></h2>
            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</p>
            <img class="img-fluid" src="img/material/material-po-pinel.jpg" alt="titulo sobre imagem">
        </div>
    </section>

    <section id="contact"> <!-- Contact -->
        <div>
            <h2 class="name-section text-center py-3">Contato <span class="dot">.</span></h2>
            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</p>
        </div>
    </section>
</main>
